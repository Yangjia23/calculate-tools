<template>
  ...
  <nut-config-provider :theme-vars="themeVars">
    <nut-cell-group>
      ...
      <nut-cell title="1年存期及年利率">
        <template #desc>
          <text>{{`${calcResult.firstRate}%`}}</text>
        </template>
      </nut-cell>
      <nut-cell title="2年存期及年利率">
        <template #desc>
          <text>{{`${calcResult.secondRate}%`}}</text>
        </template>
      </nut-cell>
      <nut-cell title="3年存期及年利率">
        <template #desc>
          <text>{{`${calcResult.thirdRate}%`}}</text>
        </template>
      </nut-cell>
...
const calcResult = ref({...thirtySixCalc.calcResult})
